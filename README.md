...
터미널에서 플래시카드 형태로 학습해요.

```bash
/flashcard            # 오늘 복습할 카드 시작
/flashcard --topic=js # 특정 토픽만
/flashcard --stats    # 통계 확인
```

what/how/why 형태의 질문으로 깊이 있는 복습을 도와줘요.

### `/growth` - 성장 시각화

학습 진행 상황을 시각적으로 확인해요.

```bash
/growth               # 이번 달 성장 현황
/growth --period=week # 이번 주
/growth --quick       # 간단 요약
```
...
### Deja-vu Alert
비슷한 에러가 발생하면 과거 해결법을 자동으로 보여줘요.
> 🔍 **이전에 비슷한 상황이 있었어요!**

### Daily One-liner
세션 종료 시 오늘의 가장 중요한 배움을 저장하도록 제안해요.
> 🌟 이번 세션에서 배운 가장 중요한 것을 한 줄로 적어보세요!

### Context Review
작업 시작 시 현재 프로젝트와 관련된 과거 배움을 보여줘요.
> 📖 **관련 학습 내용이 있어요!**
